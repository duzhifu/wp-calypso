...
import { isGoogleAnalyticsAllowed } from './index';
...
/**
 * GA may be loaded both directly via a HTML script that that is already rendered, or dynamically via the current file.
 *
